...
const ProductPage: React.FC = () => {
  ...
  return (
      <>
        <PageNavBar />
        <div className="flex flex-col h-[230vh] sm:h-[150vh] bg-white font-syne">
    <main className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-8 py-6 max-w-7xl mx-auto w-full">
        ...
        <h1 className="text-2xl font-bold mb-2">Lux denominator elly bag</h1>
        <h1 className="text-xl font-bold mb-2">N52,000</h1>
        ...
        {Object.keys(sections).map((key) => (
            ...
            {openSections[key] && <div className="pt-2 bg-[#F8F8FA] p-3">{sections[key].content}</div>}
            </div>
        ))}
        </div>
    </main>
