        ...
        <footer className="bg-white py-12 sm:py-16 px-6 sm:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-evenly sm:gap-[470px] items-start mb-12 sm:mb-20 gap-10">
                    ...
                    <div className="text-left space-y-8 w-full sm:w-auto">
                        <div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 justify-start">
                                <Link href={"https://www.instagram.com/patohner/"} target="_blank">
                ...
                <div className="text-center mb-12  w-full ">
                    <Image 
                        ...
                        width={400} 
                        height={100} 
                        className="w-full h-auto object-contain max-w-xs mx-auto md:max-w-5xl border border-b"
                        priority
                    />
                </div>

                {/* Bottom Section */}
                <div className="flex flex-col sm:flex-row justify-center sm:justify-evenly items-center text-xs sm:text-sm text-gray-500 gap-4 sm:gap-0">
                    <p className="font-syne text-center sm:text-left">©2025 PATH Co. - All Rights Reserved.</p>
