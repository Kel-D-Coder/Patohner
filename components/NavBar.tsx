...
export default function HomeNavBar() {
  ...
  return (
    <>
      <nav className="w-full text-black px-10 h-[59px] flex items-center justify-between absolute top-0 left-0 z-50 bg-gradient-to-b from-[#D9D9D980] to-black font-syne">
